    ...
    for (i=0, l=string.length; i<l; i++) {
        ...
        if (0xD800 <= c && c <= 0xD8FF) { // surrogate pair
            ...
            if (
                ...
                // FOR VIETNAMESE
                ) && (!((0x00C0 <= c && c <= 0x00C3) || (0x00C8 <= c && c <= 0x00CD) || (0x00D2 <= c && c <= 0x00D5) || (0x00D9 <= c && c <= 0x00DD) || (0x00E0 <= c && c <= 0x00E3) || (0x00E8 <= c && c <= 0x00ED) || (0x00F2 <= c && c <= 0x00F5) || (0x00F9 <= c && c <= 0x00FA) || (0x00FD == c) || (0x0102 <= c && c <= 0x0103) || (0x0110 <= c && c <= 0x0111) || (0x0128 <= c && c <= 0x0129) || (0x0168 <= c && c <= 0x0169) || (0x01A0 <= c && c <= 0x01A1) || (0x01AF == c) || (0x01B0 == c) || (0x1EA0 <= c && c <= 0x1EAC) || (0x1EA0 <= c && c <= 0x1EF9)
                ))
            ) {
                counter += 2;
            } else {
